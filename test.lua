...
pcall(function()
	getgenv().LastRayField.Name = 'Old Arrayfield'
	getgenv().LastRayField.Enabled = false
end)
...
local ParentObject = function(Gui)
	...
	getgenv().LastRayField = ArrayField
end
...
function ArrayFieldLibrary:CreateWindow(Settings)
	...
	local imageLabel = Instance.new("ImageLabel")
    	imageLabel.Image = "http://www.roblox.com/asset/?id=18636144002"
